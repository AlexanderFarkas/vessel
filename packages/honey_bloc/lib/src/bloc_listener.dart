...
class BlocListener<B extends StateStreamable<S>, S>
    extends flutter_bloc.BlocListener<B, S> with BlocListenerSingleChildMixin {
  BlocListener({
    super.key,
...
@internal
class HoneycombBlocListener<B extends BlocBase<S>, S>
    extends SingleChildStatelessWidget with BlocListenerSingleChildMixin {
